    ...
    <div className="customer-app-container bg-slate-50 min-h-screen text-slate-800 font-sans">
      ...
      <nav className="fixed bottom-0 w-full bg-white border-t border-slate-200 safe-area-pb z-50">
        <div className="flex justify-around items-center h-16 max-w-md mx-auto relative px-2">
          <Link href="/customer" className="flex flex-col items-center justify-center w-full h-full text-slate-500 hover:text-[var(--accent)] transition-colors">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
            <span className="text-[10px] uppercase tracking-wider font-bold mt-1">Home</span>
          </Link>
          <Link href="/customer/pause" className="flex flex-col items-center justify-center w-full h-full text-slate-500 hover:text-[var(--accent)] transition-colors">
          ...
          <Link href="/customer/profile" className="flex flex-col items-center justify-center w-full h-full text-slate-500 hover:text-[var(--accent)] transition-colors">
